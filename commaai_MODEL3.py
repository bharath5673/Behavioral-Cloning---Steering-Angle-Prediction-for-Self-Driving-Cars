...
plt.ylabel('# Frames')
plt.savefig('steering_angles_before_aug')      
...
with open("./model_cl-001.json", "w") as json_file:
    json.dump(model_json, json_file)
model.save_weights("./model_-001.h5")
...
plt.savefig('augmented_steering_angles')
...
plt.ylabel('loss')
plt.xlabel('batches')
plt.savefig('model_loss_batches')
